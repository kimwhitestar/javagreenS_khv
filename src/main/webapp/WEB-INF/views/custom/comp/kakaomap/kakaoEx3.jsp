...
<head>
	...
	var mapaddress = '${mapaddress}';
	  ...
	  function addressSearch() {
	  	...
	  	location.href = "${ctxPath}/customComp/kakaoEx3?mapaddress="+mapaddress;
	  }
	</script>
</head>
<body>
...
<div class="container">
  ...
  <hr/>
	<p>주소입력 :
	  <input type="text" name="mapaddress" id="mapaddress" autofocus onkeypress="if(event.keyCode==13){addressSearch();}" />
	  <input type="button" value="검색" onclick="addressSearch()" class="btn btn-success btn-sm" /> &nbsp;
	  / 검색한주소 : <font color="blue"><b>${mapaddress}</b></font>
	</p>
  <hr/>
