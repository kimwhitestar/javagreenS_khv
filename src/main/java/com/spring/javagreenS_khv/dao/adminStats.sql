...
INSERT INTO CUSTOM_COMP_HISTORY VALUES ( DEFAULT, 99999999, 1, 'O', DEFAULT, DEFAULT, 99999999, NULL, NULL, NULL, NULL, DEFAULT, 
			(SELECT CUSTOM_KIND_NM FROM CUSTOM_KIND WHERE CUSTOM_KIND_CD = 1), (SELECT GRADE_NAME FROM CUSTOM_GRADE WHERE GRADE_CODE = 'O') );
